...
function law_scripts() {
	...
	wp_enqueue_style('law-owl.theme.default.min', get_template_directory_uri() . '/assets/css/owl.theme.default.min.css');
	...
	//Include js scripts.
	wp_enqueue_script('law-modernizr-2.6.2.min.', get_template_directory_uri() . '/assets/js/modernizr-2.6.2.min.js');
	wp_enqueue_script('law-respond.min', get_template_directory_uri() . '/assets/js/respond.min.js');
	//Этот пример показывает, как добавить условие подключения зарегистрированного скрипта.
	//Например добавим условие <!--[if lt IE 9]>...<![endif]--> - для IE меньше 9.
	wp_script_add_data('law-respond.min', 'conditional', 'lt IE 9');

	wp_deregister_script('jquery');
	wp_register_script('jquery', get_template_directory_uri() . '/assets/js/jquery.min.js');
	wp_enqueue_script('jquery');

	wp_enqueue_script('law-jquery.easing.1.3', get_template_directory_uri() . '/assets/js/jquery.easing.1.3.js', array(), '', true);
	wp_enqueue_script('law-bootstrap.min', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), '', true);
	wp_enqueue_script('law-jquery.waypoints.min', get_template_directory_uri() . '/assets/js/jquery.waypoints.min.js', array(), '', true);
	wp_enqueue_script('law-jquery.stellar.min', get_template_directory_uri() . '/assets/js/jquery.stellar.min.js', array(), '', true);
	wp_enqueue_script('law-owl.carousel.min', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', array(), '', true);
	wp_enqueue_script('law-jquery.flexslider-min', get_template_directory_uri() . '/assets/js/jquery.flexslider-min.js', array(), '', true);
	wp_enqueue_script('law-jquery.countTo', get_template_directory_uri() . '/assets/js/jquery.countTo.js', array(), '', true);
	wp_enqueue_script('law-jquery.magnific-popup.min', get_template_directory_uri() . '/assets/js/jquery.magnific-popup.min.js', array(), '', true);
	wp_enqueue_script('law-magnific-popup-options.js', get_template_directory_uri() . '/assets/js/magnific-popup-options.jsn.js', array(), '', true);
...
/**
 * Here included TGM plugin activation.
 */
require_once get_template_directory() . '/inc/tgm/tgm-include-plugins.php';

/**
 * Here included Redux framework.
 */
require_once get_template_directory() . '/inc/sample-config.php';

/**
 * The filter that applies to the function the_excerpt().
 */
